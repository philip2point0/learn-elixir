...
defmodule RNATranscriptionTest do
  ...
  test "transcribes guanine to cytosine" do
    return = RNATranscription.to_rna('G')
    assert return == 'C'
    return
  end
  ...
  #@tag :pending
  test "pjb it transcribes two dna nucleotides to rna equivalents" do
    RNATranscription.to_rna('GC')
    assert RNATranscription.to_rna('GC') == 'CG'
  end
